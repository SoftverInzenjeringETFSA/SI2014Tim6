			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(btnSpasi, Alignment.TRAILING))
					.addGap(521)
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addComponent(pnlUsername, GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)
						.addComponent(pnlPassword, GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(pnlIme, GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.RELATED))
						.addComponent(pnlPrezime, GroupLayout.DEFAULT_SIZE, 85, Short.MAX_VALUE))
					.addGap(18))
		);
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGap(96)
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(pnlIme, GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE)
								.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
									.addComponent(textField, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
									.addComponent(lblIme)))
							.addPreferredGap(ComponentPlacement.RELATED)
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addComponent(pnlPrezime, GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE)
								.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
