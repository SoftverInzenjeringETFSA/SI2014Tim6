...
public class AzuriranjeRadnika {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AzuriranjeRadnika window = new AzuriranjeRadnika();
	 ...
	 */
	public AzuriranjeRadnika() {
		initialize();
	}
	
	public AzuriranjeRadnika(Restoran z, Radnik rad, DefaultListModel<Radnik> m) {
		handler = rad;
		res = z;
		lista = m;
		initialize();
